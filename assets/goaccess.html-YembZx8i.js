...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr>`,9),u=e("strong",null,"Ref:",-1),g={href:"https://goaccess.io/",target:"_blank",rel:"noopener noreferrer"};function h(v,m){const n=c("ExternalLinkIcon");return i(),o("div",null,[l,e("p",null,[u,a(),e("a",g,[a("GoAccess Official Site"),t(n)])])])}const b=s(r,[["render",h],["__file","goaccess.html.vue"]]);export{b as default};
